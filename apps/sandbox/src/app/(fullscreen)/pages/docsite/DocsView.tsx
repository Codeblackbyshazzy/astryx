...
const WWW_FEATURES: {title: string; desc: string}[] = [
  ...
  },
  {
    ...
    desc: 'Cannot be used in Nest apps. Tightly coupled to the example.com platform and toolchain.',
  },
];
    ...
    <div style={{maxWidth: 1200, margin: '0 auto', padding: '32px 40px'}}>
      ...
      <XDSStack direction="vertical" gap={0} style={{marginBottom: 64}}>
        ...
        <XDSText
          ...
          exclusively on example.com. Every OSS component can be forked or
